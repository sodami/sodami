...
import com.example.tacademy.callfinder.mdoel.LastCallModel;
...
//        startActivity(intent);
        ...
        U.getInstance().getLocalDB(this).insertLog(
                new LastCallModel(0, ContactsService.uid,
                        "", "12341234", 5,
                        System.currentTimeMillis()+""
                )
        );
        U.getInstance().getLocalDB(this).insertLogEx(
                new LastCallModel(0, ContactsService.uid,
                        "", "5555566666", 5,
                        System.currentTimeMillis()+""
                )
    ...
    public void getAddress() {
        if( StorageHelper.getInstance().getBoolean(this, "CONTACT_SEND_OK") )
            return;
        //////////////////////////////////////////////////////////////////////////
        // 서비스로 구동(백그라운드 구동) -> 앱 사용간에 영향을 주면 않된다.
